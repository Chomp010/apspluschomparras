...
class BossRush {
    constructor() {
        this.bossChoices = [
            ...
            [  1, "eggFighter"],
            [  2, "quadralBoss"],
            [  2, "triangleImperialBoss"],
            [  2, "pentagonImperial"],
            //territorials
            [  1, "eggAvengerBoss"],
            [  2, "squareTerritorialBoss"],
            [  2, "defender"],
        ...
        this.bigFodderChoices = ["sentryGun", "sentrySwarm", "sentryTrap", "squareGunSentry"/*, "shinySentryGun"*/];
    ...
    generateWaves() {
        ...
        for (let i = 0; i < 100; i++) {
            let wave = [],
                ...
                selection = ran.chooseChance(5, 1, 1, 1),
                choices = [this.bossChoices, this.bossChoicesEliteOnly, this.bossChoicesMysticalOnly, this.bossChoicesArmyOnly][selection];
