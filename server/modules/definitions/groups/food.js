...
makeUpgraded = (type, level) => ({
    PARENT: ["food"], //NOTE: Omega still unused yet
    ...
    TURRETS: [{
        POSITION: [20 * Math.SQRT1_2, 0, 0, 360/(type.SHAPE * 2), 0, 1],
        TYPE: [type]
    }]*/
});
makeRare = (type, level) => ({
...
//exports.betaCarbonEgg = makeUpgraded(exports.carbonEgg, 0);
//exports.alphaCarbonEgg = makeUpgraded(exports.carbonEgg, 1);
...
//exports.betaCarbonSquare = makeUpgraded(exports.carbonSquare, 0);
//exports.alphaCarbonSquare = makeUpgraded(exports.carbonSquare, 1);
// TRIANGLES
exports.triangle = {
    PARENT: ["food"],
    LABEL: "Triangle",
...
exports.newBetaPentagon = makeUpgraded(exports.pentagon, 0);
exports.newAlphaPentagon = makeUpgraded(exports.pentagon, 1);
...
exports.betaCarbonPentagon = makeUpgraded(exports.carbonPentagon, 0);
exports.alphaCarbonPentagon = makeUpgraded(exports.carbonPentagon, 1);
// HEXAGON
exports.hexagon = {
    PARENT: ["food"],
    LABEL: "Hexagon",
...
for (let [gemColor, name] of [
    ...
    exports[name + "BetaPentagonRelic"] = makeRelic(exports.newBetaPentagon, -0.6, gem);
    exports[name + "AlphaPentagonRelic"] = makeRelic(exports.newAlphaPentagon, -0.6, gem);
