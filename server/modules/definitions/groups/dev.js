...
*/
    [ "egg"           , "betaEgg"           , "alphaEgg"        , "EggRelic"     , "BetaEggRelic"     , "AlphaEggRelic" ],
    [ "square"        , "betaSquare"        , "alphaSquare"     , "SquareRelic"  , "BetaSquareRelic"  , "AlphaSquareRelic"    ],
    [ "triangle"      , "betaTriangle"      , "alphaTriangle"   , "TriangleRelic", "BetaTriangleRelic", "AlphaTriangleRelic"      ],
    [ "pentagon"      , "newBetaPentagon"   , "newAlphaPentagon", "PentagonRelic", "BetaPentagonRelic", "AlphaPentagonRelic"      ],
    [ "hexagon"       , "betaHexagon"       , "alphaHexagon"    , "HexagonRelic" , "BetaHexagonRelic" , "AlphaHexagonRelic"    ],
],
...
// DEV "UPGRADE PATHS"
exports.developer.UPGRADES_TIER_0 = ["basic", "betaTesterMenu", "healer", "spectator", "miscEntities", "randomTanks", "eggGenerator", "bosses", "fun", "levels", "teams"];
    exports.miscEntities.UPGRADES_TIER_0 = ["baseProtector", "dominators", "mothership", "arenaClosers", "antiTankMachineGun", "ikeBase"];
        exports.dominators.UPGRADES_TIER_0 = ["dominator", "destroyerDominator", "gunnerDominator", "trapperDominator"];
        exports.arenaClosers.UPGRADES_TIER_0 = ["arenaCloser", "twinArenaCloser", "sniperArenaCloser", "machArenaCloser", "flankArenaCloser", "directorArenaCloser", "smasherArenaCloser"];
    exports.bosses.UPGRADES_TIER_0 = ["sentries", "elites", "mysticals", "imperials", "territorials", "nesters", "rogues", "terrestrials", "celestials", "eternals", "titans", "fallenBosses", "armybosses"];
        exports.sentries.UPGRADES_TIER_0 = ["sentrySwarm", "sentryGun", "sentryTrap", "shinySentrySwarm", "shinySentryGun", "shinySentryTrap"];
        exports.elites.UPGRADES_TIER_0 = ["eliteDestroyer", "eliteGunner", "eliteSprayer", "eliteBattleship", "eliteSpawner", "eliteTrapGuard", "eliteSpinner", "eliteSkimmer", "eliteBasic"/*, "legionaryCrasher"*/];
        exports.mysticals.UPGRADES_TIER_0 = ["sorcerer", "summoner", "enchantress", "exorcistor"];
        exports.imperials.UPGRADES_TIER_0 = ["eggFighter", "quadralBoss", "triangleImperialBoss", "pentagonImperial"];
        exports.territorials.UPGRADES_TIER_0 = ["eggAvengerBoss", "squareTerritorialBoss", "defender"];
