...
GUNS : [
/*{
POSITION: [ 26.4, 6.9375, 1, 0, 0, 0, 0],
PROPERTIES: {
SHOOT_SETTINGS: combineStats([ g.basic, g.sniper, g.blank, g.blank, g.blank, g.twin, g.bent]),
TYPE: "bullet",
}, },6*/ {
POSITION: [ 23.4, 6.9375, 1, 6, 2, 15, 1/2 ],
PROPERTIES: {
SHOOT_SETTINGS: combineStats([ g.basic, g.sniper, g.blank, g.blank, g.blank, g.twin, g.bent]),
TYPE: "bullet",
}, },{
POSITION: [ 23.4, 6.9375, 1, 6, -2, -15, 0/2 ],
PROPERTIES: {
SHOOT_SETTINGS: combineStats([ g.basic, g.sniper, g.blank, g.blank, g.blank, g.bent, g.twin]),
TYPE: "bullet",
}, },{
POSITION: [ 26.4, 6.9375, 1, 12, 0, 0, 0/2 ],
PROPERTIES: {
SHOOT_SETTINGS: combineStats([ g.basic, g.sniper, g.blank, g.blank, g.blank, g.twin, g.bent]),
TYPE: "bullet",
}, },{
POSITION: [ 13.76, 6.9375, -1.5225, -1.76, 0, 0, 0],
},
],
BODY: {
