...
exports.autoSmasherBullet = {
    ...
    TURRETS: [
        ...
        {
            POSITION: [11, 0, 0, 0, 360, 1],
            TYPE: ["autoSmasherTurret", { INDEPENDENT: true }],
        },
    ],
    IS_SMASHER: true,
};
...
exports.nailtriplet = {
    ...
    GUNS: [
        {
            POSITION: [18, 8, 1, 0, 4, 0, 0.5],
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.basic, g.twin, g.triple, g.nailtriple]),
                TYPE: "bullet",
            },
        },
        {
...
exports.basic.UPGRADES_TIER_1 = ["twin", "sniper", "machineGun", "flankGuard", "director", "pounder", "trapper", "single", "minishot"/* "whirlwind"*/];
    ...
    exports.twin.UPGRADES_TIER_2 = ["doubleTwin", "tripleShot", "gunner", "hexaTank", "wark", "duo"];
        exports.twin.UPGRADES_TIER_3 = ["dual", "musket"];
        exports.doubleTwin.UPGRADES_TIER_3 = ["tripleTwin", "hewnDouble", "autoDouble", "bentDouble", "twin3"];
        exports.tripleShot.UPGRADES_TIER_3 = ["pentaShot", "spreadshot", "bentHybrid", "bentDouble", "triplet", "bentSingle"];
        exports.wark.UPGRADES_TIER_3 = ["bulwark"];

    exports.sniper.UPGRADES_TIER_2 = ["assassin", "hunter", "minigun", "rifle", "obliterator", "sniperSingle"];
        ...
        exports.obliterator.UPGRADES_TIER_3 = ["sidewinder", "obliStabilize"];
    ...
    exports.flankGuard.UPGRADES_TIER_2 = ["hexaTank", "triAngle", "auto3", "trapGuard", "triTrapper", "flankSingle"];
        ...
        exports.auto3.UPGRADES_TIER_3 = ["auto5", "mega3", "auto4", "banshee", "sniper3", "twin3", "mach3", "single3"/*, "whirl3"*/];
    ...
    exports.director.UPGRADES_TIER_2 = ["overseer", "cruiser", "underseer", "spawner", "honcho"];
        ...
        exports.spawner.UPGRADES_TIER_3 = ["factory", "autoSpawner", "megaSpawner", "software"];
            exports.software.UPGRADES_TIER_4 = ["stuxnet"];
        exports.honcho.UPGRADES_TIER_3 = ["bigCheese", "honchodrive"];

    exports.pounder.UPGRADES_TIER_2 = ["destroyer", "builder", "artillery", "launcher", "obliterator", "honcho", "singlePound"];
        exports.pounder.UPGRADES_TIER_3 = ["shotgun", "eagle"];
        exports.destroyer.UPGRADES_TIER_3 = ["conqueror", "annihilator", "hybrid", "construct", "singleDestroy", "stabilizer"];
