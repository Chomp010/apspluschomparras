module.exports = {
    ...
    nail: { reload: 0.85, recoil: 2.5, size: 0.8, damage: 0.7, density: 2 },
      nailtriple: { reload: 0.9, recoil: 2.5, size: 0.8, damage: 0.7, speed: 1.05, density: 2 },
    ...
    //redistribute: { reload: 4.75, recoil: 3, size: 0.4, health: 1.85, damage: 1.85, pen: 1.9, speed: 2, maxSpeed: 1.85, spray: 1.15, resist: 1.25 },
    obli: { reload: 2, recoil: 1.6, damage: 1.8, pen: 1.2, speed: 0.65, maxSpeed: 0.6, density: 1.5, resist: 1.15 },
    ...
    iketurret: { reload: 1.2, recoil: 0, health: 1.25, damage: 1.2, pen: 1.2, speed: 2.5, maxSpeed: 2.5, range: 0.8, density: 4, spray: 0.25 },
}
