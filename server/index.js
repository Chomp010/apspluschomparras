...
const bossSelections = [{
    bosses: [Class.eliteDestroyer, Class.eliteGunner, Class.eliteSprayer, Class.eliteBattleship, Class.eliteSpawner, Class.eliteBasic],
    location: "nest",
    amount: [5, 5, 4, 2, 1, 6],
    nameType: "a",
    chance: 2,
    ...
    bosses: [Class.fallenOverlord, Class.fallenBooster, Class.fallenHybrid, Class.fallenFalcon],
    location: "norm",
    amount: [2, 2, 2, 1],
    nameType: "a",
    message: "A strange trembling...",
...
const crasherConfig = {
    ...
    chance: 0.9,
    sentryChance: 0.95,
    crashers: [Class.crasher, Class.bladeCrasher, Class.eggCrasher],
